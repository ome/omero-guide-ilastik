...
We will show how to analyze data stored in OMERO, using the ilastik user interface, Fiji and the OMERO imageJ plugin. We will then also show how to analyze using ilastik API and OMERO.py API.
